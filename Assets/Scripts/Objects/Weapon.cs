...
public class Weapon : Item
{
    ...
    public List<Weapon> WeaponList()
    {
        ...
        weapon = new Weapon
        {
            ...
            name = "Windblade",
            flavorText = "Hasaki",
            spritePath = "Icons/yasuo",
            soundPath = "Sfx/hasaki",
            rarity = Rarity.Uncommon,
            buyValue = 60,
            sellValue = 30,
            requiredLevel = 5,
        ...
        weapon = new Weapon
        {
            ...
            soundPath = "Sfx/wingardiumleviosafx",
            rarity = Rarity.Common,
            buyValue = 50,
            sellValue = 20,
            requiredLevel = 5,
        ...
        weapon = new Weapon
        {
            itemId = 020311,
            name = "Steel Chakram",
            spritePath = "Icons/chakraml",
            soundPath = "Sfx/chakramx",
            rarity = Rarity.Common,
            buyValue = 50,
            sellValue = 20,
            requiredLevel = 5,
